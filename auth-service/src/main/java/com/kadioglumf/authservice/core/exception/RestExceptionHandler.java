...
import com.kadioglumf.authservice.core.secure.SecureException;
import com.kadioglumf.authservice.util.HttpRequestUtils;
...
public class RestExceptionHandler {
  ...
  public ResponseEntity<RestResponseError> handleMaxUploadSizeExceededException(
    ...
    BusinessException be = new BusinessException(ExceptionConstants.UNAUTHORIZED, exc);
    return prepareResponseAndLogError(
        be,
        HttpRequestUtils.createNewHttpHeadersWithExtractedMediaTypeFromRequest(request),
        HttpStatus.UNAUTHORIZED);
