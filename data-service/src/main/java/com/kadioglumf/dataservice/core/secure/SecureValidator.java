...
import com.kadioglumf.dataservice.core.dto.PermissionDto;
...
public class SecureValidator {
  ...
  @Before("@annotation(com.kadioglumf.dataservice.core.secure.SecureGroup)")
  ...
  @Before("@annotation(com.kadioglumf.dataservice.core.secure.Secures)")
  ...
  @Before("@annotation(com.kadioglumf.dataservice.core.secure.Secure)")
