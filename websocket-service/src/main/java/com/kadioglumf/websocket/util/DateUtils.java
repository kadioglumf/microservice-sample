...
public class DateUtils {
  ...
  public static Object parseStringToObjectByFormat(String dateStr) {
    try {
      ...
      throw new BusinessException(ExceptionConstants.DATE_FORMAT_NOT_FOUND_ERROR);
    } catch (BusinessException ex) {
      throw ex;
    } catch (Exception ex) {
      ex.printStackTrace();
      throw new BusinessException(ExceptionConstants.LOCAL_DATE_PARSE_ERROR, ex.getMessage());
    }
  }
