...
public class SecureValidator {
  ...
  @Before("@annotation(com.kadioglumf.authservice.core.secure.SecureGroup)")
  ...
  @Before("@annotation(com.kadioglumf.authservice.core.secure.Secures)")
  ...
  @Before("@annotation(com.kadioglumf.authservice.core.secure.Secure)")
